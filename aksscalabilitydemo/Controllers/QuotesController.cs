...
namespace aksscalabilitydemo.Controllers
{
    ...
    public class QuotesController : Controller
    {
        ...
        public IActionResult GetMany(int count)
        {
            ...
            return Ok(ListOfQuotes.OrderBy(_ => r.Next(ListOfQuotes.Length)).Take(count).Select(x => $"{machinename}-{Environment.MachineName}"));
        }
